...
echo ""
echo "Next steps:"
echo "  1. Add PROJECT_ID (and optionally DOMAIN + CERTBOT_EMAIL) to your .env:"
echo "       PROJECT_ID=$PROJECT"
echo "       DOMAIN=yourdomain.com"
echo "       CERTBOT_EMAIL=you@example.com"
echo ""
echo "  2. If using a custom domain, add a DNS A record at your registrar:"
echo "       $STATIC_IP  →  yourdomain.com"
echo "       (wait for DNS to propagate before the next step)"
echo ""
echo "  3. Run first-time setup (builds images, installs Docker, gets SSL cert, starts app):"
echo "       make setup"
echo ""
echo "  4. For future deploys:"
echo "       make deploy"
